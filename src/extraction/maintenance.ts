 ...
 * `ms365_file` joins for OneDrive via the ms-graph connector (#243); `google_drive`
 * joins for Google Drive via the google connector (#242).
 */
export const EXTRACTABLE_SOURCE_TYPES = [
  "local_file",
  "box_file",
  "ms365_file",
  "google_drive",
