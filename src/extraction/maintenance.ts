 ...
 * `ms365_file` joins for OneDrive via the ms-graph connector (#243). Google
 * Drive extends this set in its follow-up (#242).
 */
export const EXTRACTABLE_SOURCE_TYPES = ["local_file", "box_file", "ms365_file"] as const;
