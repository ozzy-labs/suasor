...
[tasks.home]
destination = "github"     # github（先行）| github_projects | jira | slack
repo = "owner/repo"         # github のとき：起票先リポジトリ
# project = "ABC"           # jira のとき：プロジェクトキー / github_projects のとき：PVT_ node id
# list = "L0123"            # slack のとき：list id
# --- github_projects（Projects v2）のとき：Status フィールド node id（project 固有・complete/reopen に必要）---
